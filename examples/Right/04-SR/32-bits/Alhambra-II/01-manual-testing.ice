{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "ec5985fe-bdba-4522-904c-4010d8678789",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "a226b68e-27d3-43ab-8efa-0004836ce6c9",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        {
          "id": "6830c015-f2b4-4cb9-b031-aa614e48b758",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## SR32 Register: Manual testing\n\nUnary counter shown in the LEDs",
            "readonly": true
          },
          "position": {
            "x": 392,
        ...
        {
          "id": "767a9849-9930-4a1c-8d77-587eb05daa67",
        ...
        {
          "id": "9324e714-6c79-40dd-a3e6-be523c14ca82",
        ...
        {
          "id": "1374683f-8c09-4206-8190-2d665e221053",
        ...
        {
          "id": "c2d2393e-d36b-4ed1-86ae-c54ed19b5a00",
          "type": "46609ea27fdbe359e620fd1535c3e1b2ec741a22",
          "position": {
            "x": 600,
            "y": 440
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "c2d2393e-d36b-4ed1-86ae-c54ed19b5a00",
        ...
        },
        {
          "source": {
            "block": "c2d2393e-d36b-4ed1-86ae-c54ed19b5a00",
            "port": "3bb796a1-e4f1-402c-b603-4b69fd39fe5e"
          },
          "target": {
            "block": "767a9849-9930-4a1c-8d77-587eb05daa67",
        ...
        },
        {
          ...
          "target": {
            "block": "ec5985fe-bdba-4522-904c-4010d8678789",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "9324e714-6c79-40dd-a3e6-be523c14ca82",
        ...
        },
        {
          ...
          "target": {
            "block": "1374683f-8c09-4206-8190-2d665e221053",
        ...
        },
        {
          ...
          "target": {
            "block": "6830c015-f2b4-4cb9-b031-aa614e48b758",
            "port": "in"
          },
          "size": 4
        },
        {
          ...
          "target": {
            "block": "a226b68e-27d3-43ab-8efa-0004836ce6c9",
            "port": "in"
          },
          "size": 8
        }
  ...
  "dependencies": {
    ...
    "46609ea27fdbe359e620fd1535c3e1b2ec741a22": {
      "package": {
        "name": "SR-32-verilog",
        "version": "0.5",
        "description": "SR-32-verilog: 32-bits Shift register to the right.  Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "3bb796a1-e4f1-402c-b603-4b69fd39fe5e",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "3bb796a1-e4f1-402c-b603-4b69fd39fe5e",
                "port": "in"
              },
              "size": 32
            }
