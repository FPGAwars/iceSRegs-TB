{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "99518dd7-e063-48ba-892f-e20a664edae5",
        ...
        {
          "id": "9ccfc950-bafb-415f-b0d2-19052889f187",
          "type": "basic.outputLabel",
          "data": {
            "name": "data",
            "range": "[15:0]",
        ...
        {
          "id": "bbb96a88-20b8-40e9-be40-dc8989cd089c",
          "type": "28d062db5357aee91ebccc28a77cbec8a644b209",
          "position": {
            "x": 344,
            "y": 432
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "bbb96a88-20b8-40e9-be40-dc8989cd089c",
        ...
        {
          "source": {
            "block": "9ccfc950-bafb-415f-b0d2-19052889f187",
            "port": "outlabel"
          },
          "target": {
            "block": "47c7ede5-13b2-4dfa-ba00-91efc6cb75eb",
        ...
        },
        {
          "source": {
            "block": "bbb96a88-20b8-40e9-be40-dc8989cd089c",
            "port": "81acfee2-e725-4d61-b8d4-6e5faf3c84dc"
          },
          "target": {
            "block": "99518dd7-e063-48ba-892f-e20a664edae5",
            "port": "inlabel"
          },
          "size": 16
        }
  ...
  "dependencies": {
    ...
    "28d062db5357aee91ebccc28a77cbec8a644b209": {
      "package": {
        "name": "Sys-SR-16-blocks-imp1",
        "version": "0.4",
        "description": "Sys-SR-16-blocks-imp1: 16-bits System Shift register to the right. Block implementation 1",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "7aa769f6-a274-4d68-86e0-299b286b79ce",
              "type": "basic.output",
              "data": {
                "name": "nc",
                "virtual": true,
            ...
            {
              "id": "e5e59c33-7f02-4d7d-8945-48e7497b41c0",
              "type": "basic.inputLabel",
              "data": {
                "name": "next",
                "range": "[15:0]",
            ...
            {
              "id": "572b6d55-4c3c-4cc0-86ed-e248cf60a758",
              "type": "basic.outputLabel",
              "data": {
                "name": "next",
                "range": "[15:0]",
            ...
            {
              "id": "f3258cd3-5371-42c3-af0b-3a33f4a67306",
              "type": "basic.outputLabel",
              "data": {
                "name": "next",
                "range": "[15:0]",
            ...
            {
              "id": "81acfee2-e725-4d61-b8d4-6e5faf3c84dc",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[15:0]",
            ...
            {
              "id": "60bb206d-a2bd-4f8c-b4c9-515abc3f9263",
              "type": "basic.input",
              "data": {
                "name": "nc",
                "virtual": true,
            ...
            {
              "id": "c5eb734b-e641-4c85-bd54-45ac8a1a76ab",
            ...
            {
              "id": "44dc761f-c6d7-4e32-99bc-f07ac47d2b68",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "44dc761f-c6d7-4e32-99bc-f07ac47d2b68",
            ...
            {
              "source": {
                "block": "f3258cd3-5371-42c3-af0b-3a33f4a67306",
                "port": "outlabel"
              },
              "target": {
                "block": "81acfee2-e725-4d61-b8d4-6e5faf3c84dc",
                "port": "in"
              },
              "size": 16
            },
            {
              "source": {
                "block": "c5eb734b-e641-4c85-bd54-45ac8a1a76ab",
                "port": "b764ed67-7b8a-4b96-a528-6ffc2e307627"
              },
              "target": {
                "block": "e5e59c33-7f02-4d7d-8945-48e7497b41c0",
                "port": "inlabel"
              },
              "size": 16
            },
            {
              "source": {
                "block": "572b6d55-4c3c-4cc0-86ed-e248cf60a758",
                "port": "outlabel"
              },
              "target": {
                "block": "44dc761f-c6d7-4e32-99bc-f07ac47d2b68",
