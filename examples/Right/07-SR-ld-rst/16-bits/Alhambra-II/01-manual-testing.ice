{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## SR16-ld-rst Register: Manual testing\n\nUnary counter shown in the LEDs",
            "readonly": true
          },
          "position": {
            "x": 392,
        ...
        {
          "id": "1d9faf2e-2b4c-41a5-b9d8-faf7ad6a1d31",
          "type": "77e184494ef69eb0dcbb1b0c78f71cfc1608643f",
          "position": {
            "x": 744,
            "y": 632
          },
        ...
        {
          "id": "4387b0e3-44d7-4018-8f72-1796006d0156",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "1d9faf2e-2b4c-41a5-b9d8-faf7ad6a1d31",
        ...
        },
        {
          ...
          "target": {
            "block": "4387b0e3-44d7-4018-8f72-1796006d0156",
        ...
        },
        {
          "source": {
            "block": "1d9faf2e-2b4c-41a5-b9d8-faf7ad6a1d31",
            "port": "01959fc8-0c3f-4f1f-9bf7-91e543381ef1"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "1d9faf2e-2b4c-41a5-b9d8-faf7ad6a1d31",
            "port": "93367365-6eba-4a50-b315-1818bb68279f"
          },
          "size": 16
        }
      ]
  ...
  "dependencies": {
    ...
    "77e184494ef69eb0dcbb1b0c78f71cfc1608643f": {
      "package": {
        "name": "SR-ld-rst-16-verilog",
        "version": "0.5",
        "description": "SR-ld-rst-16-verilog: Shift register to the right, with load.  Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "93367365-6eba-4a50-b315-1818bb68279f",
              "type": "basic.input",
              "data": {
                "name": "din",
                "virtual": true,
            ...
            {
              "id": "01959fc8-0c3f-4f1f-9bf7-91e543381ef1",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "93367365-6eba-4a50-b315-1818bb68279f",
                "port": "out"
              },
              "target": {
                "block": "2b116f4a-1eb0-4542-b65d-b383511a5085",
            ...
            },
            {
              ...
              "target": {
                "block": "01959fc8-0c3f-4f1f-9bf7-91e543381ef1",
                "port": "in"
              },
              "size": 16
            }
