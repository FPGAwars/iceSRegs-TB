{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## SR6-ld Register: Manual testing\n\nUnary counter shown in the LEDs",
            "readonly": true
          },
          "position": {
            "x": 392,
        ...
        {
          "id": "3b0112ff-dfb8-452a-b41c-7964a3d51c07",
        ...
        {
          "id": "66eecc00-2d70-4291-8999-8f671f557e7b",
        ...
        {
          "id": "d7a88a41-c6b8-40d7-a2e8-97bff23d0380",
          "type": "6ed00ee08680fd627a46b6b2fdcbec62f9607552",
          "position": {
            "x": 584,
            "y": 648
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "d7a88a41-c6b8-40d7-a2e8-97bff23d0380",
        ...
        {
          "source": {
            "block": "3b0112ff-dfb8-452a-b41c-7964a3d51c07",
        ...
        },
        {
          ...
          "target": {
            "block": "66eecc00-2d70-4291-8999-8f671f557e7b",
        ...
        },
        {
          "source": {
            "block": "d7a88a41-c6b8-40d7-a2e8-97bff23d0380",
            "port": "5765195f-0e8e-49d9-9468-dd88ef527125"
          },
          "target": {
            "block": "3b0112ff-dfb8-452a-b41c-7964a3d51c07",
        ...
        },
        {
          ...
          "target": {
            "block": "d7a88a41-c6b8-40d7-a2e8-97bff23d0380",
            "port": "ef04f38f-5e1e-4b78-95b1-5d1c88097706"
          },
          "vertices": [],
          "size": 6
        }
  ...
  "dependencies": {
    ...
    "6ed00ee08680fd627a46b6b2fdcbec62f9607552": {
      "package": {
        "name": "SR-ld-06-verilog",
        "version": "0.5",
        "description": "SR-ld-06-verilog: Shift register to the right, with load.  Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "ef04f38f-5e1e-4b78-95b1-5d1c88097706",
              "type": "basic.input",
              "data": {
                "name": "din",
                "virtual": true,
            ...
            {
              "id": "5765195f-0e8e-49d9-9468-dd88ef527125",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "ef04f38f-5e1e-4b78-95b1-5d1c88097706",
                "port": "out"
              },
              "target": {
                "block": "2b116f4a-1eb0-4542-b65d-b383511a5085",
            ...
            },
            {
              ...
              "target": {
                "block": "5765195f-0e8e-49d9-9468-dd88ef527125",
                "port": "in"
              },
              "size": 6
            }
