{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## SR16-rst Register: Manual testing\n\nUnary counter shown in the LEDs",
            "readonly": true
          },
          "position": {
            "x": 392,
        ...
        {
          "id": "60a4266b-19dd-4d8b-bc7e-3ec6a94a2808",
          "type": "1ec48e5d4e8ed792a386d5ca893ad138c653bc72",
          "position": {
            "x": 592,
            "y": 560
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "60a4266b-19dd-4d8b-bc7e-3ec6a94a2808",
        ...
        },
        {
          ...
          "target": {
            "block": "60a4266b-19dd-4d8b-bc7e-3ec6a94a2808",
            "port": "ca69a5d2-0304-4b5f-b4b7-6f13277fd9b7"
          },
          "vertices": [
            {
              "x": 528,
        ...
        },
        {
          "source": {
            "block": "60a4266b-19dd-4d8b-bc7e-3ec6a94a2808",
            "port": "14e4ce29-1dce-4d76-a8eb-ed448af58555"
          },
          "target": {
        ...
        },
        {
          "source": {
            "block": "60a4266b-19dd-4d8b-bc7e-3ec6a94a2808",
            "port": "053f4edb-cf77-4c46-ba3e-312837bf8d2a"
          },
          "target": {
  ...
  "dependencies": {
    ...
    "1ec48e5d4e8ed792a386d5ca893ad138c653bc72": {
      "package": {
        "name": "SR-rst-16-imp1",
        "version": "0.4",
        "description": "SR-rst-16-imp1: Shift register to the right, with reset.  Block implementation 1",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "6e231af8-3fd5-460e-b80e-70ee458061b2",
              "type": "basic.inputLabel",
              "data": {
                "name": "next",
                "range": "[15:0]",
            ...
            {
              "id": "687bf4ca-5bbc-46cb-a275-7216e5c463d4",
              "type": "basic.outputLabel",
              "data": {
                "name": "next",
                "range": "[15:0]",
            ...
            {
              "id": "053f4edb-cf77-4c46-ba3e-312837bf8d2a",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[15:0]",
            ...
            {
              "id": "d6120bd1-5877-4def-8fd1-856d75b19e1a",
              "type": "basic.outputLabel",
              "data": {
                "name": "next",
                "range": "[15:0]",
            ...
            {
              "id": "0c5e0c37-f129-42e4-904c-01878abdf321",
            ...
            {
              "id": "b3d2dc81-5910-4be7-8b92-e150d32e5e27",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "b3d2dc81-5910-4be7-8b92-e150d32e5e27",
            ...
            },
            {
              ...
              "target": {
                "block": "0c5e0c37-f129-42e4-904c-01878abdf321",
                "port": "ca7c5f10-efb6-43f9-9364-52d751fc0bc6"
              },
              "vertices": [
                {
            ...
            {
              "source": {
                "block": "d6120bd1-5877-4def-8fd1-856d75b19e1a",
                "port": "outlabel"
              },
              "target": {
                "block": "053f4edb-cf77-4c46-ba3e-312837bf8d2a",
                "port": "in"
              },
              "size": 16
            },
            {
              ...
              "target": {
                "block": "6e231af8-3fd5-460e-b80e-70ee458061b2",
                "port": "inlabel"
              },
              "size": 16
            },
            {
              "source": {
                "block": "687bf4ca-5bbc-46cb-a275-7216e5c463d4",
                "port": "outlabel"
              },
              "target": {
                "block": "b3d2dc81-5910-4be7-8b92-e150d32e5e27",
