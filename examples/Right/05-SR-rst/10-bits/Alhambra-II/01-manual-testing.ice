{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "eb075fc7-cb9d-490f-b4c4-dded6985e91d",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "virtual": false,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## SR10-rst Register: Manual testing\n\nUnary counter shown in the LEDs",
            "readonly": true
          },
          "position": {
            "x": 392,
        ...
        {
          "id": "1b5e879e-194a-493d-b01a-f6078f91e016",
        ...
        {
          "id": "1684d3ab-665e-477a-9a48-be3b865d868e",
          "type": "dbcb3eec4595293b8951dd815a2ff64aaaebaac5",
          "position": {
            "x": 592,
            "y": 560
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "1684d3ab-665e-477a-9a48-be3b865d868e",
        ...
        {
          "source": {
            "block": "1b5e879e-194a-493d-b01a-f6078f91e016",
            "port": "be5c72ef-8c14-447a-922c-e38e9ef6baee"
          },
          "target": {
            "block": "eb075fc7-cb9d-490f-b4c4-dded6985e91d",
            "port": "in"
          },
          "size": 16
        },
        {
          "source": {
            "block": "1684d3ab-665e-477a-9a48-be3b865d868e",
            "port": "2c7e6d53-cd10-4d0d-b48e-af6f58909a1b"
          },
          "target": {
            "block": "1b5e879e-194a-493d-b01a-f6078f91e016",
  ...
  "dependencies": {
    ...
    "dbcb3eec4595293b8951dd815a2ff64aaaebaac5": {
      "package": {
        "name": "SR-rst-10-verilog CLONE",
        "version": "0.4-c1690224642557",
        "description": "SR-rst-10-verilog: Shift register to the right, with reset.  Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "2c7e6d53-cd10-4d0d-b48e-af6f58909a1b",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "2c7e6d53-cd10-4d0d-b48e-af6f58909a1b",
                "port": "in"
              },
              "size": 10
            }
