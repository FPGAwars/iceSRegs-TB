{
    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## SR4-rst Register: Manual testing\n\nUnary counter shown in the LEDs",
            "readonly": true
          },
          "position": {
            "x": 392,
        ...
        {
          "id": "27534603-f1e8-455f-b029-686b848c4a4f",
        ...
        {
          "id": "b09ce5bc-bd3a-4fad-91d8-e9bad2ec0ef2",
          "type": "9274ebab7e6b1f79058d61c8a4787edd1fab4650",
          "position": {
            "x": 592,
            "y": 560
          },
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "b09ce5bc-bd3a-4fad-91d8-e9bad2ec0ef2",
        ...
        {
          "source": {
            "block": "27534603-f1e8-455f-b029-686b848c4a4f",
        ...
        },
        {
          "source": {
            "block": "b09ce5bc-bd3a-4fad-91d8-e9bad2ec0ef2",
            "port": "61daf344-7df4-45a0-aab6-ab63399aba65"
          },
          "target": {
            "block": "27534603-f1e8-455f-b029-686b848c4a4f",
  ...
  "dependencies": {
    ...
    "9274ebab7e6b1f79058d61c8a4787edd1fab4650": {
      "package": {
        "name": "SR-rst-04-verilog CLONE",
        "version": "0.4-c1690221562913",
        "description": "SR-rst-04-verilog: 4-bits Shift register to the right, with reset.  Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "61daf344-7df4-45a0-aab6-ab63399aba65",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "61daf344-7df4-45a0-aab6-ab63399aba65",
                "port": "in"
              },
              "size": 4
            }
