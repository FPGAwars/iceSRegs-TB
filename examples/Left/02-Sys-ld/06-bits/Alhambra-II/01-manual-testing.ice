{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "d01af4c2-3616-4e27-9ed8-fb0b0a6703ec",
        ...
        {
          "id": "045e5c62-d7f2-4502-ac45-bb07df686ef7",
        ...
        {
          "id": "a6f0e6ac-c1ec-413b-8ec0-0119152a5327",
          "type": "829ac2ec7723fa12a33d9d86a8631e350503acdd",
          "position": {
            "x": 368,
            "y": 408
          },
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "045e5c62-d7f2-4502-ac45-bb07df686ef7",
        ...
        },
        {
          ...
          "target": {
            "block": "d01af4c2-3616-4e27-9ed8-fb0b0a6703ec",
            "port": "9dad6350-1887-40ab-80e7-81fc57c7e5e7"
          }
        },
        {
          "source": {
            "block": "a6f0e6ac-c1ec-413b-8ec0-0119152a5327",
        ...
        },
        {
          "source": {
            "block": "a6f0e6ac-c1ec-413b-8ec0-0119152a5327",
            "port": "c9b21308-2f20-4acd-b6cd-95dbe54fd013"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "a6f0e6ac-c1ec-413b-8ec0-0119152a5327",
            "port": "fe8f5017-9433-476e-8336-669d2223875e"
          },
          "size": 6
        }
      ]
  ...
  "dependencies": {
    ...
    "829ac2ec7723fa12a33d9d86a8631e350503acdd": {
      "package": {
        "name": "Sys-SL6-ld-verilog",
        "version": "0.4",
        "description": "Sys-SL6-ld-verilog: 6-bits System Shift register to the left, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "8319e101-0b6f-421c-adff-8599da4778d8",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[5:0]",
            ...
            {
              "id": "c9b21308-2f20-4acd-b6cd-95dbe54fd013",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "2383235e-05fe-4845-a20a-fe9a6f90cf9b",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[5:0]",
            ...
            {
              "id": "3eb9726c-60db-480d-934f-ee4b097a7511",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[5:0]",
            ...
            {
              "id": "b40cf533-3a9d-4dfb-8ec0-75109e623fd3",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[5:0]",
            ...
            {
              "id": "fe8f5017-9433-476e-8336-669d2223875e",
              "type": "basic.input",
              "data": {
                "name": "d",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "2383235e-05fe-4845-a20a-fe9a6f90cf9b",
                "port": "outlabel"
              },
              "target": {
                "block": "c9b21308-2f20-4acd-b6cd-95dbe54fd013",
                "port": "in"
              },
              "size": 6
            },
            {
              ...
              "target": {
                "block": "8319e101-0b6f-421c-adff-8599da4778d8",
                "port": "inlabel"
              },
              "size": 6
            },
            {
              "source": {
                "block": "3eb9726c-60db-480d-934f-ee4b097a7511",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "fe8f5017-9433-476e-8336-669d2223875e",
                "port": "out"
              },
              "target": {
                "block": "b40cf533-3a9d-4dfb-8ec0-75109e623fd3",
                "port": "inlabel"
              },
              "size": 6
            },
