{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "7f547a6e-49a9-4539-89c4-d6de6295abee",
          "type": "16a5e766ebc78867bbafe174a4332cf7797e650a",
          "position": {
            "x": 368,
            "y": 400
          },
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "7f547a6e-49a9-4539-89c4-d6de6295abee",
        ...
        },
        {
          "source": {
            "block": "7f547a6e-49a9-4539-89c4-d6de6295abee",
            "port": "71411aaa-a6cf-458d-9f45-4ce6081d76e5"
          },
          "target": {
        ...
        },
        {
          ...
          "target": {
            "block": "7f547a6e-49a9-4539-89c4-d6de6295abee",
            "port": "c0b963bd-d309-4b9b-9d9b-4e7c298f7162"
          },
          "size": 16
        }
      ]
  ...
  "dependencies": {
    ...
    "16a5e766ebc78867bbafe174a4332cf7797e650a": {
      "package": {
        "name": "Sys-SL16-ld-verilog",
        "version": "0.4",
        "description": "Sys-SL16-ld-verilog: 16-bits System Shift register to the left, with load. Verilog implementation",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "ebc195e4-c9ff-4078-99fb-94549e3b78e6",
              "type": "basic.inputLabel",
              "data": {
                "name": "q",
                "range": "[15:0]",
            ...
            {
              "id": "71411aaa-a6cf-458d-9f45-4ce6081d76e5",
              "type": "basic.output",
              "data": {
                "name": "",
                "virtual": true,
            ...
            {
              "id": "2fb9e483-e0b4-43f8-af0a-64a6115f9207",
              "type": "basic.outputLabel",
              "data": {
                "name": "q",
                "range": "[15:0]",
            ...
            {
              "id": "20342803-8cef-4a6b-b8e2-6338f12ef3e6",
              "type": "basic.outputLabel",
              "data": {
                "name": "d",
                "range": "[15:0]",
            ...
            {
              "id": "25f80976-a31d-45bb-be68-5ecfe240515f",
              "type": "basic.inputLabel",
              "data": {
                "name": "d",
                "range": "[15:0]",
            ...
            {
              "id": "c0b963bd-d309-4b9b-9d9b-4e7c298f7162",
              "type": "basic.input",
              "data": {
                "name": "d",
                "virtual": true,
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "2fb9e483-e0b4-43f8-af0a-64a6115f9207",
                "port": "outlabel"
              },
              "target": {
                "block": "71411aaa-a6cf-458d-9f45-4ce6081d76e5",
                "port": "in"
              },
              "size": 16
            },
            {
              ...
              "target": {
                "block": "ebc195e4-c9ff-4078-99fb-94549e3b78e6",
                "port": "inlabel"
              },
              "size": 16
            },
            {
              "source": {
                "block": "20342803-8cef-4a6b-b8e2-6338f12ef3e6",
                "port": "outlabel"
              },
              "target": {
                "block": "065d71ce-8cdc-4298-a5fe-42613b6d5d0a",
            ...
            {
              "source": {
                "block": "c0b963bd-d309-4b9b-9d9b-4e7c298f7162",
                "port": "out"
              },
              "target": {
                "block": "25f80976-a31d-45bb-be68-5ecfe240515f",
                "port": "inlabel"
              },
              "size": 16
            },
